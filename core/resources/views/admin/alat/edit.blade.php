    ...
    <div class="card-body">
        ...
        <form action="{{ route('alat.update', $alat->id) }}" method="POST" class="row g-3">
            ...
            <div class="col-12">
                ...
                <textarea name="deskripsi" id="deskripsi" rows="3" class="form-control">{{ old('deskripsi', $alat->deskripsi) }}</textarea>
            </div>
                ...
                <div class="row g-2">
                    <div class="col">
                        ...
                        <input type="number" id="baik" name="baik" class="form-control" min="0"
                            value="{{ old('baik', $alat->baik) }}" required>
                    </div>
                    <div class="col">
                        ...
                        <input type="number" id="rusak_ringan" name="rusak_ringan" class="form-control" min="0"
                            value="{{ old('rusak_ringan', $alat->rusak_ringan) }}" required>
                    </div>
                    <div class="col">
                        ...
                        <input type="number" id="diperbaiki" name="diperbaiki" class="form-control" min="0"
                            value="{{ old('diperbaiki', $alat->diperbaiki) }}" required>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                ...
                <select name="gambar_alat_id" id="gambar_alat_id" class="form-select d-none" aria-hidden="true">
                    <option value="" {{ old('gambar_alat_id', $alat->gambar_alat_id) ? '' : 'selected' }}>Pilih file</option>
                    @foreach ($files as $file)
                        ...
                        <option value="{{ $file->id }}" data-preview="{{ $previewPath }}" data-name="{{ $fileName }}"
                            {{ (string) old('gambar_alat_id', $alat->gambar_alat_id) === (string) $file->id ? 'selected' : '' }}>
                            {{ $fileName }}
                        </option>
                    @endforeach
                </select>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- File picker logic (sama seperti create) ---
    ...
    @if(old('gambar_alat_id', $alat->gambar_alat_id))
        fileSelect.value = '{{ old('gambar_alat_id', $alat->gambar_alat_id) }}';
        updateFilePreview();
    @endif
});
</script>
@endpush@extends('layouts.layout')
